@extends('Admin.layouts.template')
    ...
    @section('title', 'Admin Seccion Home')
    ...
    @section('body')
                ...
                <div class="content-header row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-left mb-0">Seccion 1</h2>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-header">
                                    @if($count!=1)
                                        <div class="col-md-12 text-left" id="botoncrear">
                                            <a class="btn btn-primary" href="javascript:void(0)" id="createNewProduct"> Crear Seccion</a>
                                        </div>
                                    @endif
                                </div>
                    ...
                    <div class="modal-body">
                        <form id="productForm" name="productForm" class="form-horizontal" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                   <input type="file" name="img_seccion" id="img_seccion" class="form-control">
                                </div>

                                
                                <label for="name" class="col-sm-2 control-label">Descripcion:</label>
                                <input name='descripcion_seccion' id="id_description" required="" type="hidden">
        ...
        @section('script-page')
            ...
            <script src="{{asset('js/admin/admin-seccion-home.js')}}"></script>
