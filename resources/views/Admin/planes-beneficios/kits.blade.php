@extends('Admin.layouts.template')
    ...
    @section('title', 'Admin Extensiones')
    ...
    @section('body')
                ...
                <div class="content-header row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-left mb-0">Extensiones</h2>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="col-md-12 text-left">
                                        <a class="btn btn-primary" href="javascript:void(0)" id="createNewProduct"> Crear Extension</a>
                                    </div>
                                </div>
                    ...
                    <div class="modal-body">
                        <form id="productForm" name="productForm" class="form-horizontal" enctype="multipart/form-data" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" id="nombre_kit" name="nombre_kit" value="" required="">
                                </div>

                                
                                <label for="name" class="col-sm-2 control-label">Descripcion:</label>
                                <input name='descripcion_kit' id="id_description" required="" type="hidden">
                                ...
                                {{--<div class="col-sm-12">
                                    <textarea class="form-control mb-1" id="descripcion_kit" name="descripcion_kit" rows="8" value="" required=""></textarea>
                                </div>--}}
                                ...
                                {{--<span class="col-sm-2 control-label" style="font-size: 0.85rem"> Precio Suscripcion: </span>
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" id="precio_suscripcion" name="precio_suscripcion" value="" required="">
                                </div>--}}

                                <label for="name" class="col-sm-2 control-label">Imagen:</label>
                                <div class="col-sm-12">
                                   <input type="file" name="img_kit" id="img_kit" class="form-control">
                                </div>
        ...
        @section('script-page')
            ...
            <script src="{{asset('js/admin/admin-kits.js')}}"></script>
