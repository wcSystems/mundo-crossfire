@extends('Admin.layouts.template')
    ...
    @section('title', 'Admin Texto Cuotas')
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-left mb-0">Texto Cuotas</h2>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-header">
                                @if($count!=1)
                                    <div class="col-md-12 text-left" id="botoncrear">
                                        <a class="btn btn-primary" href="javascript:void(0)" id="createNewProduct">Agregar Contenido</a>
                                    </div>
                                @endif
                            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="productForm" name="productForm" class="form-horizontal" enctype="multipart/form-data" method="post">
                        @csrf
                        <input type="hidden" name="cuotas_id" id="cuotas_id" value="">
                        <div class="form-group">

                            <label for="name" class="col-sm-2 control-label">Descripcion:</label>
                            <input name='descripcion_cuotas' id="id_description" required="" type="hidden">
    ...
    @section('script-page')
        ...
        <script src="{{asset('js/admin/admin-cuotas.js')}}"></script>
