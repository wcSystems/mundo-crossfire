@extends('Admin.layouts.template')
    ...
    @section('title', 'Admin Suscripciones Inactivas')
    ...
    @section('body')
                ...
                <div class="content-header row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="content-header-title float-left mb-0">Suscripciones Inactivas</h2>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        @section('script-page')
            ...
            <script src="{{asset('js/admin/admin-clientes-no-pago-suscripcion.js')}}"></script>
