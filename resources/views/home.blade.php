                                                                                        ...
                                                                                        <li class="ast-article-single align-center box-shadow-1 box-shadow-3-hover ast-product-gallery-layout-horizontal ast-product-gallery-with-no-image ast-product-tabs-layout-horizontal ast-qv-on-image product type-product post-243 status-publish first instock product_cat-alimentos-para-mascotas has-post-thumbnail featured shipping-taxable purchasable product-type-simple">
                                                                                            <div class="astra-shop-thumbnail-wrap">
                                                                                                <a href="{{ route('shop-detail',$producto->slug) }}" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                                                                                    <img style="width:100%;height:100%;height:300px;object-fit: contain" alt="" src="{{ Storage::url('products/'.$producto->img_principal)}}" class="imgDestacados attachment-woocommerce_thumbnail size-woocommerce_thumbnail lazyload" />
                                                                                                </a>
                                                                                            </div>
                                                                                                ...
                                                                                                <div class="elementor-form-fields-wrapper elementor-labels-above">
                                                                                                    ...
                                                                                                    <div class="elementor-field-group elementor-column elementor-field-type-submit elementor-col-100 e-form__buttons">
                                                                                                        <div style="width: 100%;display: flex">
                                                                                                            <button type="button" style="width: 50px !important;height: 50px !important;background:var(--global-primary);color:#fff;border-radius: 50% !important;display: flex !important;margin-left: auto !important;padding: unset !important" onclick="EnviarMensaje($('#form-field-name').val(),$('#form-field-message').val())">
