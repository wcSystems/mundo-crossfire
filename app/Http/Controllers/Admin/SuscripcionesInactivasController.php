...
class SuscripcionesInactivasController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('Admin.clientes.clientes-no-pago-suscripcion');
    }
    ...
    public function fechasSuscripciones($id_sus){
        ...
        $fechas=Fecha_Suscripcion::where('suscripcion_id',$id_sus)->get();
