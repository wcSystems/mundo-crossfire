...
$(document).ready(function() {
    ...
    var table = $('.data-table').DataTable({
        ...
        columns: [
            ...
            {data: 'ordenados', name: 'ordenados'},
            {data: 'desta', name: 'desta'},
            {data: 'cantidad', name: 'cantidad'},
            {data: 'precio_no_afiliados', name: 'precio_no_afiliados'},
            {data: 'precio_afiliados', name: 'precio_afiliados'},
            {data: 'precio_promocion', name: 'precio_promocion'},
            {data: 'precio_envio', name: 'precio_envio'},
    ...
    //LIMPIAR INPUT DE IMAGENES
    $('body').on('click', '#clearButton', function (){
        var input_imagen= document.getElementById('imagen')
        input_imagen.value= '';
    });

    //VALIDACION DE NRO DE ORDEN DE MUESTRA
