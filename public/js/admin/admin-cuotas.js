$(function () {
    ...
    $('body').on('click', '.editProduct', function () {
        var cuotas_id = $(this).data('id');
        $.get('/admin-cuotas' +'/' + cuotas_id +'/edit', function (data) {
    ...
    $('body').on('click', '.deleteProduct', function (){
        var cuotas_id = $(this).data("id");
            ...
            Swal.fire({
            title: 'Esta Seguro?',
            text: "Desea eliminar la informacion mostrada acerca de las cuotas?",
            type: 'warning',
    ...
    $('body').on('click', '.ver', function (){
        ...
        $.get('/admin-cuotas' +'/' + cuotas_id , function (data) {
            $('#ver').modal('show');
           
            var text=data.cuotas
