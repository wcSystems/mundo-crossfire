$(function () {
    ...
    $('body').on('click', '.editProduct', function () {
        ...
        $.get('/admin-suscripciones' +'/' + suscripto_id +'/edit', function (data) {
    ...
    $('body').on('click', '.deleteProduct', function (){
        var suscripto_id = $(this).data("id");
            ...
            if (result.value) {
                    ...
                    $.ajax({
                        type: "DELETE",
                        url: "/admin-suscripciones"+'/'+suscripto_id,
                        success: function (data) {
                            table.draw();
    ...
    $('body').on('click', '.ver', function (){
        ...
        $.get('/admin-suscripciones' +'/' + suscrip_id , function (data) {
            var datos=data
